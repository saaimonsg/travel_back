...
INSERT INTO app_user (id,email, is_driver, name, password, surname, username,role)
VALUES (1, 'string@string.com', false, 'string', '$2a$10$rQHngaa1FrHUHI/o/4rao.rkKqjuzeAKhwta.Qhyl5h6ce3WQsWxO', 'string', 'string','admin');
